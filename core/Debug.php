...
class Debug {
	 ...
	 * @return string
	 */
	public static function var_dump_plain(mixed $var, $expLevel, $depth = 0, $done = array()): string
	{
		$html = '';
		if ($expLevel > 0) {
			$expLevel--;
	 ...
	 * @return string
	 */
	public static function htmlEntities(string $string, bool $preserve_encoded_entities = false): string
	{
	 ...
	 * @return string
	 */
	protected static function mbInternalEncoding(string|null $encoding = null): string
	{
